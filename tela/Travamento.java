...
import threads.Tremdoistravamento;
import threads.Tremumtravamento;
import java.awt.Font;
import java.awt.event.*;
import static threads.Tremumtravamento.velocidadetremum;
import static threads.Tremdoistravamento.velocidadetremdois;
/*=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
Nome.....: Bandeira.java
Funcao...: Classe Travamento, onde todos as acoes de interface da variavel de travamento serao administradas.
=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=*/
public class Travamento {

  public static JFrame janela = new JFrame("Variavel de travamento"); //JFrame, onde tudo sera desenhado.

  public static Tremumtravamento tremum = new Tremumtravamento();

  public static Tremdoistravamento tremdois = new Tremdoistravamento();
  ...
  public static int travareagiaoum = 0; //Variavel de travamento da regiao critica um.
                        
  public static int travareagiaodois = 0; //Variavel de travamento da regiao critica dois.

  //Fonte uzada nos botoes. 
  ...
  public Travamento(){
    ...
    //Adicionando os botoes, os trens e os trilhos.
    janela.add(iniciar);
  ...
  } //Fim do contrutor Travamento().      
} //Fim da classe Travamento.